...
<body>
	...
	<form method="post" action="update" enctype="multipart/form-data">
			...
			<div class="input-group mb-3">
				...
				<input type="text" id="isbn" name="isbn" class="form-control" value="${book.isbn }" readonly="readonly">
			</div>
			<div class="input-group mb-3">
			...
			<div class="mb-3">
				...
				<input type="file" id="file" name="file" class="form-control" accept="image/*" value="${book.img }">
			</div>
			<div class="mb-3">
