...
<body>
	...
	<div class="container">
				...
				<tbody>
					<tr>
						...
						<td rowspan="5"><img id="cover"
							src="${root }/resources/upload/${book.img }"></td>
					</tr>
					<tr>
						<td>도서명</td>
						<td>${book.title }</td>
		...
		<div class="row">
			...
			<div class="col d-flex justify-content-end"><a href="${root }/update?isbn=${book.isbn}">[수정]</a> <a href="${root }/delete?isbn=${book.isbn}">[삭제]</a></div>
		</div>
	</div>
</body>
</html>