					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="emailid"
								name="emailId" value="${loginUser.emailId }" /> <span
								class="input-group-text">@</span> <select class="form-select"
								id="emaildomain" name="emailDomain" aria-label="이메일 도메인 선택">
								<option value="${loginUser.emailDomain }" selected>${loginUser.emailDomain }</option>
            ...
            <div class="mb-3">
             ...
             -->
					<div class="col-auto text-center">
						...
						<button type="button" id = "btn-delete" class="btn btn-outline-danger mb-3">삭제</button>
					</div>
				</form>
			</div>
		</div>
	...
	<script>
      ...
      document.querySelector("#btn-update").addEventListener("click", function () {
        if (!document.querySelector("#username").value) {
          ...
          form.setAttribute("action", "${root}/board/user/update");
          form.submit();
        }
      });
      ...
      document.querySelector("#btn-delete").addEventListener("click", function () {
            let form = document.querySelector("#form-info");
            form.setAttribute("action", "${root}/board/user/delete");
            form.submit();
      });
    </script>
</body>
